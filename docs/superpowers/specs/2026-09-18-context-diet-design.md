...
```json
{"decision": "block",
 "reason": "Result dieted: 18422 chars replaced with a 300-char head.",
 "hookSpecificOutput": {
   "hookEventName": "PostToolUse",
   "additionalContext": "<head>\n[codex-context-diet] Ran: npm test -- --reporter=verbose. 18422 chars omitted; re-run the command if you need the full output."}}
```
