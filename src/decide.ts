...
import type { CallAnswer, CallDecision, JevQuestions, Message, ToolCall, ToolUse } from './types.js';
...
export function reductionRatio(result: { stats: { charsBefore: number; charsAfter: number } }): number {
