 ...
 */
export function handleStopGuard(payload, env) {
    ...
    if (recent.length < RECOVERY_WARN_AT)
        return '';
    ...
    return JSON.stringify({
        systemMessage: '[codex-context-diet] ' + recent.length + ' dropped results were re-run in the last 15 minutes. ' +
            'Consider a higher minTokens or a tool policy for the commands involved.',
    });
}
//# sourceMappingURL=stopGuard.js.map